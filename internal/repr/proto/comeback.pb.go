...
func (x FileInfoProto_Type) Enum() *FileInfoProto_Type {
	p := new(FileInfoProto_Type)
	*p = x
	return p
}
func (x FileInfoProto_Type) String() string {
	return proto.EnumName(FileInfoProto_Type_name, int32(x))
}
func (x *FileInfoProto_Type) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(FileInfoProto_Type_value, data, "FileInfoProto_Type")
	if err != nil {
		return err
	}
	*x = FileInfoProto_Type(value)
	return nil
}
...
func (m *FileInfoProto) GetType() FileInfoProto_Type {
	...
	return FileInfoProto_TYPE_UNKNOWN
}
...
func init() {
	proto.RegisterEnum("repr_proto.FileInfoProto_Type", FileInfoProto_Type_name, FileInfoProto_Type_value)
}
