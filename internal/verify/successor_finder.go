...
//
// The visitor reads directory blobs, parses them, and returns their children
// as adjacent nodes. For file nodes, the visitor verifies that their score
// exists (according to allScores), and verifies that the blob can be loaded if
// readFiles is true. A record is written to the supplied channel for
// everything that is verified. This makes this SuccessorFinder a bit weird, in
